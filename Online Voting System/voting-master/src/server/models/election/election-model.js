 ...
 * @member {String} private_master_key
...
class Election extends Model {
  ...
  fields() {
    return {
      ...
      main_election_id: {
        header: 'Main Election', type: 'string', subtype: 'mid',
      },
      master_key: {header: 'Key', type: 'string', subtype: 'vlong'},
      electoral_regions_id: {
        header: 'Region', type: 'string', subtype: 'short',
      },
  ...
  static get relationMappings() {
    ...
    const VotingSystems = require('./voting-systems-model');
    ...
    return {
      ...
      electionSystem: {
        relation: Model.BelongsToOneRelation,
        modelClass: VotingSystems,
        join: {
          from: `${Election.tableName}.type`,
          through: {
            from: `${ElectionTypes.tableName}.ElectionTypes`,
            to: `${ElectionTypes.tableName}.voting_system`,
          },
          to: `${VotingSystems.tableName}.id_voting_system`,
        },
      },
    };
  }
