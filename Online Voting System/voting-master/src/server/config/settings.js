...
const adminMenu = {
  'Elections': {
    ...
    'Voters': ['/admin/voters/', 'Voters'],
    'Check for voting record':
      ['/admin/check-for-voting-record', 'Check for voting record'],
  }, 'Candidates': {
  ...
  head: {
    css: {
      ...
      all: {
        ...
        ballot: 'rel="stylesheet" href="/static/css/ballot.css" type="text/css"',
...
const icons = {
  ...
  vote: {
    voteYes: '< i class= "fas fa-vote-yea" ></i>',
    voteNo: '< i class= "fas fa-vote-nay" ></i>',
    voteTick: '<i class="fal fa-check-square"></i>',
    voteX: '<i class="fal fa-times-square"></i>',
    voteEmpty: '<i class="fal fa-square"></i>',
  },
  disp: {
    ballot: '<i class="fas fa-ballot"></i>',
    ballotBox: '<i class="fas fa-box-ballot"></i>',
    calender: '<i class= "fas fa-calendar" ></i>',
    calenderEnd: '<i class= "fas fa-calendar-times" ></i>',
    clipboardList: '<i class= "fas fa-clipboard-list" ></i>',
    clipboardDone: '<i class= "fas fa-clipboard-check" ></i>',
  },
};
